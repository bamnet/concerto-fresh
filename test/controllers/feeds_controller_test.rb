...
class FeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should allow system user to update feed" do
    ...
    assert_redirected_to feed_url(@feed)
    @feed.reload
    assert_equal "Updated by system user", @feed.name
  end

  test "should not allow non-system-user to update feed" do
  ...
  test "should not allow non-system-user to destroy feed" do
